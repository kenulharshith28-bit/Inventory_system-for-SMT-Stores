...
INSERT INTO `header_infor` (`id`, `customer_name`, `work_order`, `mrn_no`, `cut_qty`, `location`, `work_date`, `status`, `created_at`) VALUES (1,'Polo','111111','11111',3100,'E/5/1','2026-04-06','pending','2026-04-06 08:40:10'),(2,'Lacoste','550951001','124578',0,'A/5/3','2026-04-08','received','2026-04-08 07:12:52');
...
INSERT INTO `master_data` (`id`, `type`, `value`, `created_at`) VALUES (3,'description','Urgent Order','2026-04-06 02:21:00'),(4,'description','Export Order','2026-04-06 02:21:00'),(5,'item','buttons','2026-04-06 08:36:20'),(6,'customer','Polo','2026-04-06 08:38:05'),(9,'customer','L.L Bean','2026-04-08 06:51:51'),(10,'customer','Lacoste','2026-04-08 06:52:03'),(11,'size','XS','2026-04-08 07:09:38');
...
INSERT INTO `product_information` (`id`, `work_order`, `item_code`, `item`, `colour`, `size`, `unit`, `mr_qty`, `created_at`, `ignored`, `shortage_ignored`) VALUES (1,'111111','12','buttons','','xs','Pcs',100,'2026-04-06 08:40:10',0,0),(2,'550951001','8BULL','buttons','DK BROWN','XS','Pcs',450,'2026-04-08 07:12:53',0,0);
...
INSERT INTO `receivings` (`id`, `product_id`, `qty`, `date`, `note`, `created_at`) VALUES (1,1,10,'2026-04-07','123','2026-04-07 08:08:15'),(2,1,91,'2026-04-07','1222','2026-04-07 14:07:52'),(3,2,10,'2026-04-08','','2026-04-08 07:13:29'),(4,2,100,'2026-04-08','10','2026-04-08 07:13:38');
...
-- Dump completed on 2026-04-17 21:00:02
